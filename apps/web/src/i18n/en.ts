...
export const en: Messages = {
  ...
  setup: {
    ...
    chooseLanguage: "1. Choose language",
    ...
    step2Title: "3. Initialize / upgrade schema",
    ...
    running: "Running…",
    needStep1: "Available after step 2 (bind META in the Dashboard).",
    recheck: "Recheck",
  ...
  project: {
    ...
    confirmDetach: "Detach {kind} resource {name}?",
    confirmDeleteCfResource:
      "Also delete the Cloudflare resource? (Cancel = detach only)",
    confirmDeleteProject: "Delete project {ref}? This cannot be undone.",
    confirmDeleteCfOnProject: "Also delete attached Cloudflare KV/D1 resources?",
    ...
    saved: "Saved",
    deleted: "Deleted",
    confirmDeleteKey: "Delete key {name}?",
